    ...
    return (
        <article className="product" onClick={handleNavigate}>
            <header className="product__header">
                <img className="product__img product__img-1" src={product.images[0]?.url} />
                <img className="product__img product__img-2" src={product.images[1]?.url} /> 
                </header>
                <section className="product__body">
                    ...
                    <button className="product__btn" onClick={handleAddCart}>
                        <i className='bx bx-cart product__iconcanrt'></i>
                    </button>
                </section>
        </article>
    )
